...
function AddPost({isAuthenticated,addPost}) {
    ...
    const onSubmit = e => {
        e.preventDefault();
        (handleValidation())&&addPost(city,phone,size,price,description);
    };
            ...
            <div>
                ...
                <div className="md:flex ">
                    ...
                    <div className="md:w-3/6 my-3">
                        ...
                        <input  className="w-5/6 h-12 border border-gray-500 text-right"  name="price" placeholder="سعر القارورة " type="text" required  onChange={e=>onChange(e)} />
                ...
                <div className="md:flex ">
                    ...
                    <div className="md:w-3/6 my-3">
                        ...
                        <input  className="w-5/6 h-12 border border-gray-500 text-right" name="phone" placeholder="xx xx xx xx xx/xxx xxx xxx" type="text" required onChange={e=>onChange(e)} />
                ...
                */}
                ...
                <div className=" ">
                    <div className=" my-3 ">
                        ...
                        <textarea placeholder="بامكانك اضافة ملاحظة" className=" w-5/6 h-28 border border-gray-500 text-right" name="description"   type="text" onChange={e=>onChange(e)} /> <br/>
                    </div>
                </div>
            </div>
